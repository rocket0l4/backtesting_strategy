...
fig.add_trace(go.Scatter(x=data.index, y=data['Cumulative_Profit'], mode='lines', name='Cumulative Profit',
                         line=dict(color='orange', dash='dash')))

# Customize layout
fig.update_layout(title='Bitcoin Price and Backtest Signals', xaxis_title='Date',
                  yaxis_title='Price / Cumulative Profit',
